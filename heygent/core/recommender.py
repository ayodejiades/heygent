...
""".strip()
        ...
        raw = _claude_multi_turn(RECOMMENDER_SYSTEM_PROMPT, self.history)
...
def _claude_multi_turn(system: str, messages: list[dict]) -> str:
    """Call Claude with a full message history for multi-turn support."""
